    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Begin - MAIN CONTENT -->
                <form:form class="user" method="post" modelAttribute="userCreateDto">
                    ...
                    <div class="form-group">
                        <form:password class="form-control" path="matchingPassword" placeholder="Powtórz hasło"/>
                    ...
                    <a href='<c:url value="/admin/list"/>' class="btn btn-google">
                        Anuluj
                    </a>
                </form:form>
                <!-- End - MAIN CONTENT -->
