        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href='<c:url value="/admin/institution/list"/>'
                ...
                <form:form class="user" method="post" modelAttribute="institution">
                    <div class="form-group">
                        <form:input class="form-control" path="name" placeholder="Podaj nazwę"/>
                        <div class="errorDiv"><form:errors path="name" cssClass="errorMsg"/></div>
                    </div>

                    <div class="form-group">
                        <form:input class="form-control" path="description" placeholder="Podaj opis"/>
                        <div class="errorDiv"><form:errors path="description" cssClass="errorMsg"/></div>
                    </div>

                    <button type="submit" class="btn btn-primary">
                        Zapisz
                    </button>
                    <a href='<c:url value="/admin/institution/list"/>' class="btn btn-google">
                        Anuluj
                    </a>
                </form:form>
                <!-- End - MAIN CONTENT -->
